...
//     . All rights reserved.
// </copyright>
// <summary>RequestData class having method to provide person lookup request URL and create the request data.</summary>
// ***********************************************************************
...
namespace Utilities
{
    public class RequestData
    {
        ...
        /// <returns>returns WhitePages person lookup request Url</returns>
        public string GetWhitePagesPeronLookupRequest(ref string requestType)
        {
            string whitePagesPersonLookupRequestUrl = string.Empty;

            whitePagesPersonLookupRequestUrl = ServerApis.WhitePagesPersonLookupApi;
            requestType = GetRequest;

            return whitePagesPersonLookupRequestUrl;
        }
