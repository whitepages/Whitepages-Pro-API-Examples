...
public class PersonAddressService {
	...
	/**
	 * This method to calls method doGetPersonAddressLookupData to get response
	 * of API and calls parseDataResponse to parse the result and returns
	 * PersonAddressLookupData object.
	 * 
	 ...
	 */
	public Result getPersonAddressLookupData(String firstName, String lastName, String address) {
	...
	/**
	 * This method parse json response for person lookup data. 
	 * @param jsonResponse address lookup JSON response.
	 * @return Result for person lookup data.
	 */
	private Result parseDataResponse(String jsonResponse) {
		Result personAddressLookupData = null;
