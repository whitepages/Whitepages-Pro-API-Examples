...
<html>
	...
	<body>
		<div class="wrapper">
			...
			%>
						<div class="error_box">Please enter first name.</div>
			<%
					}else {
			%>
			...
			<%
						...
						Result resultData = personAddressService.getPersonAddressLookupData(firstName, lastName, address);
						if(resultData != null) {
			...
			<%
											Person[] personDataArary = resultData.personDataArary;
											if(personDataArary != null && personDataArary.length > 0) {
												for(Person personData: personDataArary) {
			%>
													<tr>
														<td>
															<p><%=personData.name%></p> 
			...
			<%
														Location locationData = personData.locationData;
			...
			%>
															<td>
																...
																<p>
																	...
																	<%=locationData.isReceivingMail ? "Yes" : "No"%>
																</p>
																<p>
																	<span>Usage:</span>
																	<%=locationData.usage%>
