...
// Created          : 08-06-2014
//
// Last Modified By : Shah
// Last Modified On : 11-05-2014
// ***********************************************************************
// <copyright file="RequestData.cs" company="Whitepages Pro">
//     . All rights reserved.
// </copyright>
// <summary>RequestData class having method to provide address lookup request URL and create the request data.</summary>
// ***********************************************************************
...
namespace Utilities
{
    public class RequestData
    {
        ...
        /// <returns>returns WhitePages address lookup request Url</returns>
        public string GetWhitePagesAddressLookupRequest(ref string requestType)
        {
            string whitePagesAddressLookupRequestUrl = string.Empty;

            whitePagesAddressLookupRequestUrl = ServerApis.WhitePagesAddressLookupApi;
            requestType = GetRequest;

            return whitePagesAddressLookupRequestUrl;
        }
