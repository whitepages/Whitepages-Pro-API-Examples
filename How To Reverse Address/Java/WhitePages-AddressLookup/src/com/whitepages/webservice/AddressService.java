...
public class AddressService {
	...
	/**
	 * This method to calls method doGetAddressLookupData, to parse the result
	 * call parseDataResponse and returns AddressLookupData object.
	 * 
	 * @param streetLine address string.
	 * @param city city string.
	 * @return AddressLookupData.
	 */
	public Result getAddressLookupData(String streetLine, String city) throws UnsupportedEncodingException {
		...
		resultData = parseDataResponse(response);
	...
	private Result parseDataResponse(String jsonResponse) {
		...
		if (jsonResponse != null && !jsonResponse.equals("")) {
			...
			resultData = addressLookupParser
					.parseAddressLookupData(jsonResponse);
		}
