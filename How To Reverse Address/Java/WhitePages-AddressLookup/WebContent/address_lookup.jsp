		...
		<div class="wrapper">
			<div class="search_section">
				...
				<form method="post" action="address_lookup.jsp">
					<input type="text" name="street_line_1" value='' id="street_line_1" class="inputbox_address" placeholder="Street Address or name">
					<input type="text" name="city" value='' id="city" class="inputbox_address" placeholder="City and State or Zip">
			...
			<%
			    		...
			    		Result resultData = addressService.getAddressLookupData(streetName, cityName);
			    		if(resultData != null) {
			    			if(!resultData.isError) {
			%>
			    				<%@ page import="com.whitepages.data.Location"%>
			    				<%@ page import="com.whitepages.data.Person"%>
			    	
			    				<div class="detail_wrapper">
				    				<div class="location_box">
										<h1>Location</h1>
			<%
										Person[] personDataArray = null;
										Location locationData = resultData.locationData;
			...
			%>
											...
											<div class="detail_boxin">
												<p>
													...
													<%=locationData.isReceivingMail ? "Yes" : "No"%></p>
												<p>
													<span>Usage:</span>
													<%=locationData.usage%>
												</p>
			...
			<%
										if(personDataArray != null && personDataArray.length > 0) {
											for(Person personData : personDataArray) {
			%>
												<div class="detail_boxin">
													<p><%=personData.name%></p>
													<p>
