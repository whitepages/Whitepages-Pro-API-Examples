    ...
    <div class="detail_box">
        ...
        <div class="detail_boxin">
            ...
            if (!empty($value['phone']['phone_carrier'])) { ?>
                <p><span>Carrier:</span> <?php echo $value['phone']['phone_carrier']; ?> </p>
            <?php
            }
            ?>
        </div>
        <div class="detail_boxin">
            ...
            if (!empty($value['phone']['phone_type'])) { ?>
                <p><span>Phone Type:</span> <?php echo $value['phone']['phone_type']; ?> </p>
            <?php
            }
            if (!empty($value['phone']['do_not_call'])) { ?>
                <p><span>Do not Call registry:</span> <?php echo $value['phone']['do_not_call']; ?></p>
            <?php
            }
            if (!empty($value['phone']['reputation'])) { ?>
                <p><span>SPAN Score:</span> <?php echo $value['phone']['reputation']; ?>%</p>
            <?php
            }
            ?>
        </div>
        ...
        <?php foreach($value['people'] as $key => $val) { ?>
            <div class="detail_boxin">
                ...
                if (!empty($val['people_type'])) { ?>
                    <p><span>Type:</span> <?php echo $val['people_type']; ?></p>
                <?php
                }
                ?>
            </div>
        ...
        <?php foreach($value['location'] as $l_key => $l_val) { ?>
            <div class="detail_boxin">
                ...
                if (!empty($l_val['is_receiving_mail'])) { ?>
                    <p><span>Receiving mail:</span>  <?php echo $l_val['is_receiving_mail']; ?></p>
                <?php
                }
                if (!empty($l_val['usage'])) { ?>
                    <p><span>Usage:</span> <?php echo $l_val['usage']; ?></p>
